...
recipes = [
    ...
    },
    {
        ...
        'tags': ['Kevin', 'Bon Appetit', 'Salad', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Bon Appetit',
    ...
    },
    {
        ...
        'ingredients': ['1 red chili or jalapeño', '1 in. fresh ginger', '2 garlic cloves', '4 cardamom pods', '1 tsp ground coriander', '1/2 tsp ground tumeric', '2 pints cherry tomatoes', '1/4 cup unsweetened coconut cream', '1 lb cod fillets', 'basil'],
        'ingredients_subset': [],
        'directions': ['Heat oil in a medium skillet over medium until melted. Add chile, ginger, and garlic and cook, stirring often, until garlic has softened but not taken on any color, about 3 minutes. Add cardamom, coriander, and turmeric and cook, stirring, until fragrant, about 30 seconds. Add tomatoes and cook, stirring occasionally, until most of the tomatoes have burst and released their liquid, 12–15 minutes. Stir in coconut cream; taste and season curry with salt.', 'Reduce heat to medium-low. Season cod with salt and nestle into curry. Cover and cook at a bare simmer until fish is opaque throughout and beginning to flake, 5–7 minutes (thicker pieces will take longer to cook).', 'Transfer cod to shallow bowls. Stir basil into tomato curry, then spoon over fish.'],
        'photo': '/static/images/poached-cod-tomato-curry.jpg',
        'tags': ['Kevin', 'Bon Appetit', 'Entree', 'Favorite', 'Healthy', 'Kate'],
        'formatted_tags': '',
        'source_name':'Bon Appetit',
    ...
    },
    {
        ...
        'tags': ['Kevin', 'Bon Appetit', 'Entree', 'Vegetarian', 'Light', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Bon Appetit',
    ...
    },
    {
        ...
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/cheesy-pasta-broccoli.jpg',
        'tags': ['Kevin', 'Bon Appetit', 'Entree', 'Vegetarian'],
        'formatted_tags': '',
        'source_name':'Bon Appetit',
    ...
    },
    {
        ...
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/chili-halftime.jpg',
    ...
    },
    {
        ...
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/spicy-chicken-soup.jpg',
        'tags': ['Kevin', 'Bon Appetit', 'Entree', 'Soup', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Bon Appetit',
        'source': 'https://www.bonappetit.com/recipe/spicy-chicken-soup'
    },
    {
        'name': 'Pulled Pork',
        'ingredients': [],
    ...
    {
        'name': 'Herbed Egg Salad',
        'ingredients': [],
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/herbed-egg-salad.jpg',
        'tags': ['Kevin', 'Bon Appetit', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Bon Appetit',
        'source': 'https://www.bonappetit.com/recipe/herbed-egg-salad'
    },
    {
        'name': 'Irish Blind Stew',
        'ingredients': [],
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/blind-stew.jpg',
        'tags': ['Kevin', 'Soup', 'Entree', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Irish Cookbook',
        'source': ''
    },
    {
        'name': 'Ham',
    ...
    },
    {
        ...
        'ingredients': [],
        'ingredients_subset': [],
        'directions': ['Summer version: mushrooms with soba noodles, serve cold.', 'Winter version: beef and bok choy with udon noodles, serve hot.'],
    ...
    },
    {
        ...
        'ingredients': [],
        'ingredients_subset': [],
        'directions': ['Serve wtih apple sauce, and sour cream with fresh dill or chives.'],
        'photo': '/static/images/latkes.jpg',
        'tags': ['Kevin', 'Entree', 'Breakfast', 'Vegetarian'],
        'formatted_tags': '',
        'source_name':'',
        'source': ''
    },
    {
        ...
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/pasta-sauce.jpg',
        'tags': ['Kevin', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'',
        'source': ''
    ...
    },
    {
        ...
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/veggie-dip.jpg',
        'tags': ['Kevin', 'Small plate',],
        'formatted_tags': '',
        'source_name':'All recipes',
        'source': 'https://www.allrecipes.com/recipe/229126/moms-famous-raw-vegetable-dip/'
    },
    {
        'name': 'Mussels in Spicy Tomato Sauces',
        'ingredients': [],
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/mussels.jpg',
        'tags': ['Kevin', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Cooking Light',
        'source': 'https://www.cookinglight.com/recipes/mussels-with-spicy-tomato-sauce'
    },
    {
        ...
        'tags': ['Heather', 'Entree', 'Favorite', 'Easy', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Damn Delicious',
        'source': 'https://damndelicious.net/2013/11/13/sesame-ginger-salmon/'
    },
    {
        'name': 'Sweet Potato and Kale Fried Wild Rice',
        'ingredients': [''],
        'ingredients_subset': [''],
        'directions': [''],
        'photo': '/static/images/sweet-potato-kale-wild-rice-salad.jpg',
        'tags': ['Heather', 'Entree', 'Salad', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Iowa Girl Eats',
        'source': 'https://iowagirleats.com/caramelized-sweet-potato-kale-fried-wild-rice/'
    },
    {
        'name': 'Cobb Salad',
        'ingredients': ['romain lettuce', '8 slices bacon', '4 hard boiled eggs', '12 oz chicken', '1 avocado', '5 oz cherry tomatoes', 'optional: goat cheese', 'optional: red pepper', 'optional: cucumber'],
        'ingredients_subset': ['1/3 cup red wine vinegar', '1 tbsp dijon mustard', '2/3 olive oil', 'salt', 'pepper'],
        'directions': ['Prep: Cook and chop bacon. Hard-boil, peel, and chop eggs. Cook and dice chicken. Slice avocado.', 'Mix dressing.', 'Combine and serve.'],
        'photo': '/static/images/cobb-salad.jpg',
        'tags': ['Heather', 'Entree', 'Salad'],
        'formatted_tags': '',
        'source_name':'Delish',
        'source': 'https://www.delish.com/cooking/recipe-ideas/recipes/a58703/best-cobb-salad-recipe/'
    },
    {
        'name': 'Elote Bowl',
    ...
    },
    {
        ...
        'ingredients': ['1 1/2 cups jasmine rice', '1/4 cup cachews', '2 zucchini', '2 yellow squash', 'bag of mini sweet peppers', '1 peach', '5 cloves garlic', '2-3 Thai chiles', '2 tbsp soy sauce', '2 tbsp sugar', '1 tbsp Worcestershire sauce'],
        'ingredients_subset': [],
        'directions': ['Cook the rice with 1 1/4 cups water for 14-16 min.', 'Toast the cashews: heat oil over medium-high heat and cook for 4-6 min.', 'Prepare the vegetables: cut zucchini and squash into half-moons, thinly slice sweet peppers and peach, mince garlice, mince Thai chili peppers.', 'Make the sauce: mix soy sauce, sugar, and Worcestershire with a whisk.', 'Stir-fry: heat oil over medium heat, add zucchini, squash, and sweet peppers 3-5 min. Add Thai chiles and garlic and cook 30 seconds. Add sauce, peaches, and salt, and cook 2-3 min.', 'Stir most of cashews into rice, serve everything topped with remaining cashews.'],
    ...
    {
        'name': 'Tofu Halloumi',
        'ingredients': ['1 full watermelon', '3 zucchini', '2 packages tofu', '4+ tbsp zaatar', '4+ tbsp nutritional yeast', '4 tbsp almonds'],
        'ingredients_subset': [],
        'directions': ['Prep Zucchini: cut into thirds and then slice into 1/2 inch planks the long way.', 'Prepare the halloumi: drain tofu and slice length-wise into 6 pieces per block. Combine zaatar, yeast, salt, and pepper and coat the tofu.', 'Char the zucchini: heat a skillet over medium heat, toast almonds for 3-4 min, increase heat to high and add oil. Add sliced zucchini and cook 2-3 min, add salt and pepper.' , 'Sear the halloumi: return skillet to medium-high heat, add oil, add tofu, cook 3-4 min per side.', 'Serve topped with watermelon and toasted almonds.'],
    ...
    },
    {
        ...
        'tags': ['Heather', 'Entree', 'Bowl', 'Asian', 'Healthy'],
        'formatted_tags': '',
    ...
    },
    {
     ...
     },
     {
        ...
        'ingredients': ['3/4 cup quinoa', '8 oz Yukon gold potatoes', 'red beets', 'radishes', '8 oz kale', '1 garlic clove', '1 lemon', '1/4 cup sunflower seeds or walnuts', '2 tbsp parmesan', '2 oz cashew cheese'],
        'ingredients_subset': [],
        'directions': ['Prep: prehead oven to 425 degrees F. Make qunioa. Dice potatoes, peel and dice beets, quarter radishes, chop 1/2 the kale.', 'Roast the veggies: Place potatoes, beets, radishes, and 1/2 the kale on a baking sheet. Toss wtih 1 tbsp oil and salt. Roast 20-25 min.', 'Make pesto: Destem the kale and roughly chop the leaves. Peel the garlic. Halve and juice the lemon. Add kale, garlic, lemon juice, sunflower seeds or walnuts, parmesan, 3 tbsp olive oil, 1/2 tsp salt, and 1/4 tsp pepper to a food processor. Blend until well combined.', 'Serve with quinoa base, roasted veggies, and topped with pesto and cashew cheese.'],
        'photo': '/static/images/roasted-vegetable-bowls.jpg',
        'tags': ['Heather', 'Healthy', 'Vegetarian', 'Entree', 'Purple Carrot', 'Kate'],
        'formatted_tags': '',
        'source_name':'Purple Carrot',
     ...
     },
     {
        ...
        'ingredients': ['1 lime', '2 shallots', '3 garlic cloves', '1 tbsp ground ginger', '1 lemongrass stalk or 2 zested lemons', '12oz mushrooms', '1 tomato', '~25oz coconut milk', '2 vegetable bouillon cubes', '1 cup sushi rice', 'miso paste (optional)'],
        'ingredients_subset': [],
        'directions': ['Prep: Mince the shallots and garlic. Halve the lemongrass or zest the lemons. Dice tomato.', 'Rice: make the rice.', 'Build the soup: heat 1tbsp vegetable oil in pot over medium-high heat. Add shallots, ginger, garlic, and salt and cook 1-2 min. Add coconut milk, bouillon cubes, and 2 cups water. Bring to a boil, reduce heat to simmer. Add lemongrass or lemon zest, diced tomato, lime juice, and miso paste and let simmer. Remove lemongrass stalk before serving.', 'Heat 2 tbsp vegetable oil over medium-high heat. Add mushrooms, salt, and pepper and cook 5-8 min. Break into smaller pieces with spatula.', 'Serve: add rice and mushrooms to bowls, ladel in soup.'],
     ...
     {
        'name': 'Dal Makhani',
        'ingredients': ['1 onion', '3 garlic cloves', '1 oz fresh ginger', '1/3 cup lentils', '1/4 tsp cumin seeds', '1 tbsp curry powder', '13oz coconut milk', '2 tsp sugar', '1 lemon', '2 tbsp butter'],
        'ingredients_subset': [],
        'directions': ['Prep: dice onion. Peel and mince garlic and ginger. Rinse lentils.', 'Saute: heat 1tbsp oil in saucepan over medium heat. Add cumin seeds and cook 30 sec. Add onion, ginger, garlic, and cook 3-4 min. Add curry powder and cook 1 min.', 'Simmer: add the lentils, coconut milk, sugar, and 1 1/2 cups water. Bring to a boil, cover, and reduce heat. Simmer 22-25 min.', 'Add lemon juice, butter, and 1/2 tsp of salt. Serve (or freeze). Can make with brown rice and tomato chutney if desired.'],
     ...
     },
     {
        ...
        'ingredients': ['1 bunch cauliflower', '2 garlic cloves', '3/4 cup flour', '3 tbsp gochujang', '2 tbsp ketchup', '3 tbsp sugar', '2 tbsp rice vinegar', 'honey', 'miso paste (optional)'],
        'ingredients_subset': [],
        'directions': ['Prep: preheat oven to 425 degrees F. Chop cauliflower into bite-sized pieces. Mince garlic.', 'Add flour, 3/4 cup cold water, and 1/2 tsp salt to large bowl and whisk to combine. Toss cauliflower in batter. Grease baking sheet with 1 tbsp oil, add battered cauliflower, and bake 18-20 min.', 'Add garlic, gochujang, ketchup, sugar, salt, honey, miso paste, and 1/4 cup water and whisk well. Once sauce is bubbling, add baked cauliflower and toss to coat.', 'Return cauliflower to baking sheet, and bake for 7-9 min.'],
    ...
    },
    {
        ...
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/prosciutto-peach-burrata-chicken.jpg',
        'tags': ['Heather', 'Healthy', 'Entree'],
        'formatted_tags': '',
        'source_name':'Katherine, Half Baked Harvest',
        'source': 'https://www.halfbakedharvest.com/prosciutto-balsamic-peach-chicken/',
     },
     {
        'name': 'Curry Chicken Salad',
        'ingredients': ['1 shredded chicken', '1 cup mayo', '1/4 tsp ginger', '1 tsp curry powder', '1 garlic clove', '1 tsp honey', '1 tbsp lime juice', 'green grapes'],
        'ingredients_subset': [],
        'directions': ['Prep: Boil chicken or use rotisserie, and shred. Halve grapes.', 'Combine all ingredients in a bowl and chill.'],
        'photo': '/static/images/curry-chicken-salad.jpg',
        'tags': ['Heather', 'Healthy', 'Entree'],
        'formatted_tags': '',
     ...
     },
     {
        ...
        'ingredients': ['7 slices bacon', '2 garlic cloves', '8 oz cream cheese', '1/2 cup half and half', '4 oz blue cheese crumbled', '2 tbsp chives', '3 tbsp chopped smoked almonds'],
        'ingredients_subset': [],
        'directions': ['Prep: preheat oven to 350 degrees F. Mince garlic, chop chives, chop almonds, bring cream cheese to room temperature.', 'Cook bacon over medium-high heat until almost crisp, ~7 min. Drain excess fat, add garlic and cook until bacon is crisp, ~3 min.', 'Beat cream cheese until smooth. Add half and half and beat until combined. Stir in bacon mixture, blue cheese, and chives. Transfer to ovenproof dish.', 'Bake 30 min, sprinkel with chopped almonds, and serve with crackers, bread, or vegetables.', 'Note: if making ahead, can refridgrate up to 1 day and bring back up to room temperature before baking.'],
        'photo': '/static/images/blue-cheese-dip.jpg',
     ...
     },
     {
        ...
        'ingredients': ['4-6 boneless chicken breast', '1 bottle BBQ sauce', '1/4 cup cider vinegar', '1/2 tsp red pepper flakes', '1 white onion'],
        'ingredients_subset': [],
        'directions': ['Prep: Mix BBQ sauce with all ingredients except chicken & onion. Slice onions.', 'Spray Crockpot with PAM and put chicken in. Put sliced onions on top, then pour sauce over and cook on low for 4 hours.'],
        'photo': '/static/images/crockpot-bbq-chicken.jpg',
        'tags': ['Heather', 'Entree'],
        'formatted_tags': '',
        'source_name':'Katherine',
        'source': 'https://www.purplecarrot.com/plant-based-recipes/korean-bbq-cauliflower-wings-with-kimchi-potato-salad',
     ...
     {
        'name': 'Cashew Shrimp and Veggie Stir-Fry',
        'ingredients': ['3/4 lb shrimp', '1 tbsp cornstarch', '1/4 cup oyster sauce', '2 tbsp canola oil', '4 garlic cloves', '4 tsp fresh ginger', '2 bunches broccolini', '4 carrots', '1 red bell pepper', '1 cup red cabbage', 'green onions', '1 tbsp sesame oil', '1 cup cashews', 'red pepper flakes'],
        'ingredients_subset': ['white rice'],
        'directions': ['Prep: cook rice. Grate garlic and ginger. Chop broccolini, red pepper, carrots, and cabbage. In a small bowl, whisk together cornstarch, oyster sauce, and 3/4 cup water.', 'Toss shrimp with salt and pepper. Heat 1 tbsp oil in wok over high heat. Add shrimp and cook until pink and just cooked through, 2-4 min. Remove shrimp to plate.', 'Add remaining 1 tbsp oil, garlic, and ginger. Cook, stirring, 30 sec. Add broccolini, carrot, and bell pepper. Cook, tossing occasionally, until vegetables are bright in color and just starting to turn tender, about 2 minutes.', 'Add red cabbage and return shrimp to skillet. Pour in cornstarch mixture. Cook, stirring, until sauce thickens and coats shrimp and vegetables, about a few minutes more.', 'Stir in cashews; serve over rice, topped with green onions, more cashews, and red pepper flakes.'],
        'photo': '/static/images/cashew-shrimp-veggie-stir-fry.jpg',
        'tags': ['Heather', 'Entree', 'Healthy', 'Kate'],
        'formatted_tags': '',
        'source_name':'Delish',
        'source': 'https://www.delish.com/cooking/recipe-ideas/a31402221/these-4-insanely-delicious-recipes-are-secretly-healthy/',
     },
     {
        'name': 'Chicken Thighs in Mushroom Sauce',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/chicken-mushroom-sauce.jpg',
        'tags': ['Heather', 'Entree','Healthy'],
        'formatted_tags': '',
        'source_name':'What\'s in the Pan, from Mom',
        'source': 'https://whatsinthepan.com/skillet-chicken-mushroom-sauce/',
     },
    {
        ...
        'tags': ['Heather', 'Small Plate', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Online',
     ...
     },
    {
        ...
        'tags': ['Heather', 'Small Plate', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Online',
    ...
    },
    {
        ...
        'tags': ['Heather', 'Entree', 'Easy', 'Healthy'],
        'formatted_tags': '',
    ...
    },
	{
	 ...
	 },
	 {
	    ...
	    'tags': ['Heather', 'Salad', 'Vegetarian', 'Healthy'],
	    'formatted_tags': '',
     ...
     },
	 {
	    ...
	    'tags': ['Heather', 'Breakfast', 'Healthy'],
	    'formatted_tags': '',
	 ...
	 },
	 {
	    ...
	    'tags': ['Heather', 'Entree', 'Easy', 'Favorite', 'Healthy'],
	    'formatted_tags': '',
	    'source_name':'Kevin <3',
	    'source': '',
	 },
     ...
     },
	 {
	    ...
	    'tags': ['Heather', 'Soup', 'Vegetarian', 'Healthy'],
	    'formatted_tags': '',
	    'source_name':'Delish',
	 ...
	 },
     {
        ...
        'ingredients_subset': [],
        'directions': '',
        'photo': '/static/images/sausage.jpg',
        'tags': ['Heather', 'Entree'],
        'formatted_tags': '',
        'source_name':'',
        'source': ''
    },
	{
	 ...
	 },
	 {
	    ...
	    'tags': ['Heather', 'Small Plate', 'Salad', 'Vegetarian', 'Healthy'],
	    'formatted_tags': '',
	    'source_name':'Diabetes Self Management Magazine',
	    'source': '/static/sources/mediterranean.jpg',
	 },
	{
     ...
     },
     {
        ...
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/spinach-dip.jpg',
        'tags': ['Heather', 'Small Plate', 'Vegetarian'],
        'formatted_tags': '',
        'source_name':'Mom',
        'source': 'https://www.culinaryhill.com/knorr-spinach-dip-recipe/',
     },
     {
     ...
     {
        'name': 'Mediterranean Side Salad',
        'ingredients': ['1 can Great Northern Beans', '1 cup grape tomatoes', '1 cucumber', '2 tbsp red onion', '1 tbsp cilantro'],
        'ingredients_subset': ['1 tbsp olive oil', '1 tbsp lime juice', '1/4 tsp salt', '1/8 tsp black pepper'],
        'directions': ['Prep: rinse beans, halve tomatoes, dice cucumber and red onion, chop cilantro.', 'Make dressing: whisk together olive oil, lime juice, salt, and pepper.', 'Mix and serve.'],
        'photo': '/static/images/mediterranean-salad.jpg',
        'tags': ['Heather','Small Plate',],
        'formatted_tags': '',
        'source_name':'Dad, Diabetes Magazine',
        'source': 'https://www.diabetesselfmanagement.com/recipes/snack/grape-tomato-salad-white-beans-cucumber/',
     },
     {
     ...
     },
     {
        ...
        'tags': ['Heather','Small Plate', 'Armenian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Rose Baboian\'s Cook Book',
     ...
     },
     {
        ...
        'tags': ['Heather','Entree', 'Armenian', 'Healthy', 'Healthy'],
        'formatted_tags': '',
    ...
    },
    {
        ...
        'tags': ['Heather', 'Entree', 'Armenian', 'Healthy'],
        'formatted_tags': '',
    ...
    },
    {
        ...
        'tags': ['Heather', 'Entree', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
    ...
    },
    {
        ...
        'tags': ['Heather', 'Breakfast', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
    ...
    },
    {
        ...
        'ingredients_subset': [],
        'directions': [],
        'photo': '/static/images/apple-cider-donuts.jpg',
        'tags': ['Heather', 'baking'],
        'formatted_tags': '',
        'source_name':'Boston Chefs',
        'source': 'https://www.bostonchefs.com/recipe/apple-cider-donuts/'
    },
    {
    ...
    },
    {
     ...
     },
     {
        ...
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/fried-rice.jpg',
        'tags': ['Heather', 'Asian'],
        'formatted_tags': '',
        'source_name':'Tasty',
        'source': 'https://tasty.co/compilation/4-ways-to-make-fried-rice',
     },
     {
        'name': 'Buddha Bowls Recipe',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/buddha-bowls.jpg',
        'tags': ['Heather', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Delish',
        'source': 'https://www.delish.com/cooking/menus/recipes/a50768/buddha-bowls-recipe/',
     },
     {
        'name': 'Sweet Potato Squash Black Bean Enchiladas',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/enchiladas.jpg',
        'tags': ['Heather', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Thug Kitchen',
        'source': 'https://thekindlife.com/blog/2014/10/thug-kitchen-sweet-potato-squash-black-bean-enchiladas/',
     },
     {
        'name': 'Spiced Chickpea Wraps with Tahini',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/chickpea-wraps.jpg',
        'tags': ['Heather', 'Vegetarian', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Thug Kitchen',
        'source': 'https://samhodges.co/thug-kitchen-spiced-chickpea-wraps-tahini-dressing/',
     },
    {
        'name': 'Butternut Squash',
        'ingredients': ['1 butternut squash', '1 1/2 tbp olive oil', '1 1/2 tbsp maple syrup', '1 tsp salt', '1 tsp cinnamon', '1/2 tsp black pepper', '1 tbsp fresh rosemary'],
        'ingredients_subset': [],
        'directions': ['Preheat oven to 400 degrees F and grease baking sheet.', 'Peel and dice the squash.', 'Add squash, olive oil, salt, cinnamon, and black pepper to a bowl and toss to coat.', 'Spread out on the baking sheet, bake 10-15 min.', 'Remove, add rosemary, and serve.'],
        'photo': '/static/images/butternut-squash.jpg',
        'tags': ['Heather', 'Vegetarian', 'Small Plate'],
        'formatted_tags': '',
        'source_name':'Mom\'s Email',
        'source': '',
     },
     {
        'name': 'Roasted Sweet Potatoes',
        'ingredients': ['3 sweet potatoes', 'olive oil', 'salt', 'pepper', 'chili powder', 'paprika', 'cumin', 'garlic powder'],
        'ingredients_subset': [],
        'directions': ['Preheat oven to 425 degrees F', 'Peel and dice sweet potato. Coat with olive oil and spices.', 'Roast 30 min, flipping every 10 min.'],
        'photo': '/static/images/sweet-potato.jpg',
        'tags': ['Heather', 'Vegetarian', 'Small Plate', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Chelsea\'s Messy Apron',
        'source': 'https://www.chelseasmessyapron.com/roasted-sweet-potatoes/',
     },
     {
        'name': 'Salmon Cakes',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/salmon-cakes.jpg',
        'tags': ['Heather', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Laurel, Natasha\'s Kitchen',
        'source': 'https://natashaskitchen.com/salmon-cakes-recipe/',
     },
     {
        'name': 'Butternut Squash Curry with Spinach',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/butternut-squash-curry.jpg',
        'tags': ['Heather', 'Vegetarian', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Healthy Nibbles',
        'source': 'https://healthynibblesandbits.com/vegan-butternut-squash-curry-with-spinach/',
     },
     {
        'name': 'Greek-inspired Veggie Burger',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/greek-veggie-burger.jpg',
        'tags': ['Heather', 'Vegetarian', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Weight Watchers',
        'source': 'https://www.weightwatchers.com/us/recipe/greek-inspired-veggie-burger/5b194763bf4ee41a72c7a372',
     },
     {
        'name': 'Roasted Salmon, Chickpeas, Zucchini & Pepper',
        'ingredients': ['1 red bell pepper', '1 can chickpeas', '2 zucchini', '1 red onion', '1lb salmon', 'plain yogurt (optional)', 'lemons (optional)'],
        'ingredients_subset': ['1 1/2 tsp paprika', '1 tsp corriander', '1 tsp cumin', '1 tsp salt', '3/4 tsp black pepper'],
        'directions': ['Prep: Preheat oven to 450 degrees F. Slice red pepper, red onion, and zucchini. Rinse chickpeas. Mix spices.', 'Combine red pepper, red onion, zuchinni, chickpeas on baking sheet. Add 1 tbsp oil and 4 tsp spice mixture, toss, and bake for 20 min.', 'Cut salmon into 4 equal pieces, coat with 1 tbsp oil and 2 tsp spice mixture.', 'Remove sheet pan from oven, clear space for 4 salmon pieces, and return to oven for 10 min.', 'To serve, can add lemon and/or yogrurt as desired.'],
        'photo': '/static/images/roasted-veggies.jpg',
        'tags': ['Heather', 'Side', 'Entree', 'Healthy', 'Kate'],
        'formatted_tags': '',
        'source_name':'Weight Watchers',
        'source': 'https://www.weightwatchers.com/us/recipe/roasted-salmon-with-chickpeas-zucchini-and-red-pepper/59ff9b3c424c8e2582cdf025',
     },
     {
        'name': 'Ground Turkey and Peppers',
        'ingredients': [''],
        'ingredients_subset': [],
        'directions': [''],
        'photo': '/static/images/ground-turkey-peppers.jpg',
        'tags': ['Heather', 'Entree', 'Healthy'],
        'formatted_tags': '',
        'source_name':'Simply recipes',
        'source': 'https://www.simplyrecipes.com/recipes/moms_ground_turkey_and_peppers/',
     },
     {
        'name': 'Chicken Rollatini',
        'ingredients': ['1 lb thin chicken cutlets', 'proscuito', 'whipped chive cream cheese', 'asparagus'],
        'ingredients_subset': [],
        'directions': ['Preheat oven to 375 degrees F.', 'Pat chicken cutlets dry and season with salt and pepper on both sides. Spread a spoonful of cream cheese on one side, then roll chicken from small side into roll. Wrap with a slice or two of prosciutto.', 'Bake for 20 min.'],
        'photo': '/static/images/chicken-rollatini.jpg',
        'tags': ['Heather', 'Entree' ],
        'formatted_tags': '',
        'source_name':'Katherine',
        'source': '',
     ...
     },
     {
        ...
        'ingredients': ['12 oz enchilada sauce', '1 rotisserie chicken', '6 tortillas', '1 onion', '2 cloves garlic', 'taco seasoning', '1 1/2 cup mexican cheese', 'scallions'],
        'ingredients_subset': [],
